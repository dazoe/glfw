...
const (
	...
	Platform            Hint = C.GLFW_PLATFORM              //specifies the platform to use for windowing and input.
)

// Platform hint values. (Use with glfw.InitHint)
const (
	AnyPlatform     = C.GLFW_ANY_PLATFORM     // Specifies that the platform should be chosen automatically.
	Win32Platform   = C.GLFW_PLATFORM_WIN32   // Specifies that the Win32 platform should be used.
	MacPlatform     = C.GLFW_PLATFORM_COCOA   // Specifies that the Cocoa platform should be used.
	WaylandPlatform = C.GLFW_PLATFORM_WAYLAND // Specifies that the Wayland platform should be used.
	X11Platform     = C.GLFW_PLATFORM_X11     // Specifies that the X11 platform should be used.
	NullPlatform    = C.GLFW_PLATFORM_NULL    // Specifies that no platform should be used.
)
